...
const VideoCard = lazy(() => import("./Steps/StepsVideoCard"));
  ...
  return (
    <section className="steps-section min-h-dvh">
      <div className="h-full flex lg:flex-row flex-col items-center relative">
        <div
          className="lg:w-[57%] flex-none h-80 lg:h-full md:mt-20 xl:mt-0"
          ref={titleRef}
        >
          <StepsTitle />
        </div>
        ...
        <div className="h-full">
          <div
            className="lg:h-dvh min-h-dvh md:min-h-fit w-full mt-0 md:mt-20 xl:mt-0"
            ref={sliderRef}
          >
